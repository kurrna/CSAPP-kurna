...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp                    # 分配 8 字节栈空间
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi               # %esi = 期望字符串地址 (0x402400)
  400ee9:	e8 4a 04 00 00       	callq  401338 <strings_not_equal>    # 比较输入(%rdi)与期望字符串
    400eee:	85 c0                	test   %eax,%eax                    # 检查返回值 (0 表示相等)
    400ef0:	74 05                	je     400ef7 <phase_1+0x17>         # 相等则跳到 0x400ef7 结束
    400ef2:	e8 43 05 00 00       	callq  40143a <explode_bomb>         # 否则引爆
    400ef7:	48 83 c4 08          	add    $0x8,%rsp                    # 恢复栈空间
    400efb:	c3                   	retq                                # 返回

0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp                        # 保存被调用者保存寄存器
  400efd:	53                   	push   %rbx                        # 保存被调用者保存寄存器
  400efe:	48 83 ec 28          	sub    $0x28,%rsp                  # 为 6 个 int 分配空间
  400f02:	48 89 e6             	mov    %rsp,%rsi                   # %rsi = 六个数字的缓冲区
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>    # 读取 6 个 int 到栈上
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                 # 第一个数字必须为 1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>        # 正确则跳到 0x400f30 初始化循环
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>        # 否则引爆
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>        # 仍然跳转到循环初始化
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax             # 取前一个数字
  400f1a:	01 c0                	add    %eax,%eax                   # eax = 前一个数字 * 2
  400f1c:	39 03                	cmp    %eax,(%rbx)                 # 与当前数字比较
  400f1e:	74 05                	je     400f25 <phase_2+0x29>        # 当前 == 前一个*2 则继续
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>        # 否则引爆
  400f25:	48 83 c3 04          	add    $0x4,%rbx                   # 移动到下一个 int
  400f29:	48 39 eb             	cmp    %rbp,%rbx                   # 是否到达末尾
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>        # 回到 0x400f17 继续循环
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>        # 跳到 0x400f3c 结束
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx              # %rbx = &numbers[1]
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp             # %rbp = &numbers[6]
...
# 在 0 和 14 之间执行二分查找
# 若 arg1 = mid，则返回0
# 若 arg1 < mid，则返回 2 * func4(arg1, arg2, mid - 1)
# 若 arg1 > mid，则返回 2 * func4(arg1, mid + 1, arg3) + 1
0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax
  400fd4:	29 f0                	sub    %esi,%eax                    # arg3 - arg2
  400fd6:	89 c1                	mov    %eax,%ecx
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx                   
  400fdb:	01 c8                	add    %ecx,%eax
  400fdd:	d1 f8                	sar    %eax                         # eax = (eax < 0) ? (eax - 1) / 2 : eax / 2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx           # mid = arg2 + (arg3 - arg2) / 2
  400fe2:	39 f9                	cmp    %edi,%ecx                    # 比较 arg1 和 arg2 + (arg3 - arg2) / 2
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>          # 如果 arg1 >= mid 跳转到 0x400ff2
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx              # arg3 = mid - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>               # 当 arg1 < mid 时递归调用 func4
  400fee:	01 c0                	add    %eax,%eax                    # eax = eax * 2
  400ff0:	eb 15                	jmp    401007 <func4+0x39>          # 跳到 0x401007 结束
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax                    # %eax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx                    # 比较 arg1 和 mid
  400ff9:	7d 0c                	jge    401007 <func4+0x39>          # 如果 mid >= arg1 跳转到 0x401007
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi               # arg2 = mid + 1
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>               # 当 arg1 > mid 时递归调用 func4
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx               # %rcx = &arg2
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx               # %rdx = &arg1
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi               # "%d %d"
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax                    # 检查是否成功读取两个整数  
  40102c:	75 07                	jne    401035 <phase_4+0x29>        # 跳转到0x401035引爆
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)               # 检查第一个输入是否小于等于14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>        # 小于等于则跳转0x40103a
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                    # %edx = 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                    # %esi = 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi               # %edi = arg1
  401048:	e8 81 ff ff ff       	callq  400fce <func4>               # 调用 func4
  40104d:	85 c0                	test   %eax,%eax                    # 返回值为0则标志位ZF设置为1
  40104f:	75 07                	jne    401058 <phase_4+0x4c>        # 若返回值不为0（ZF为0）则跳转到0x401058引爆
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51>        # 若第二个输入为0则跳到0x40105d结束
  401058:	e8 dd 03 00 00       	callq  40143a <explode_bomb>
  40105d:	48 83 c4 18          	add    $0x18,%rsp
  401061:	c3                   	retq   

0000000000401062 <phase_5>:
  401062:	53                   	push   %rbx               			# 保存被调用者保存寄存器
  401063:	48 83 ec 20          	sub    $0x20,%rsp             		# 分配32字节栈空间
  401067:	48 89 fb             	mov    %rdi,%rbx                    # 保存输入字符串指针到 %rbx
  40106a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax                # 栈保护检查
  401071:	00 00 
  401073:	48 89 44 24 18       	mov    %rax,0x18(%rsp)              # 保存栈保护值
  401078:	31 c0                	xor    %eax,%eax                    # 清零 %eax，作为索引使用
  40107a:	e8 9c 02 00 00       	callq  40131b <string_length>		# 计算输入字符串长度
  40107f:	83 f8 06             	cmp    $0x6,%eax					# 检查长度是否为6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>		# 是则跳到0x4010d2继续
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>		# 
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>		# 继续执行
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx			# 取输入字符串的每个字符，ecx = input[i]
  40108f:	88 0c 24             	mov    %cl,(%rsp)					# 将字符存储到栈上（%cl和%dl分别是%ecx和%edx的低8位）
  401092:	48 8b 14 24          	mov    (%rsp),%rdx					# 取出该字符
  401096:	83 e2 0f             	and    $0xf,%edx					# 取低4位作为索引
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx			# 使用索引从表中取值
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)		# 存储转换后的字符
  4010a4:	48 83 c0 01          	add    $0x1,%rax					# 增加索引
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax					# 检查是否处理完6个字符
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>		# 未处理完则继续
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)				# 在转换后的字符串末尾添加空字符
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi				# %esi = 期望字符串地址 0x40245e = "flyers"
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi				# %rdi = 转换后的字符串地址
  4010bd:	e8 76 02 00 00       	callq  401338 <strings_not_equal>	# 比较字符串
  4010c2:	85 c0                	test   %eax,%eax					# 检查返回值
  4010c4:	74 13                	je     4010d9 <phase_5+0x77>		# 返回值为0则跳到结束
  4010c6:	e8 6f 03 00 00       	callq  40143a <explode_bomb>		# 否则引爆
  4010cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)				# 对齐指令
  4010d0:	eb 07                	jmp    4010d9 <phase_5+0x77>		# 跳转到 0x4010d9 结束
  4010d2:	b8 00 00 00 00       	mov    $0x0,%eax					# 初始化索引为 rax = 0
  4010d7:	eb b2                	jmp    40108b <phase_5+0x29>		# 跳转到 0x40108b 处理每个字符
  4010d9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax				# 取出栈保护值
  4010de:	64 48 33 04 25 28 00 	xor    %fs:0x28,%rax				# 检查栈保护
  4010e5:	00 00 
  4010e7:	74 05                	je     4010ee <phase_5+0x8c>		# 若栈未被破坏则继续
  4010e9:	e8 42 fa ff ff       	callq  400b30 <__stack_chk_fail@plt>	# 栈保护失败处理
  4010ee:	48 83 c4 20          	add    $0x20,%rsp					# 恢复栈空间
  4010f2:	5b                   	pop    %rbx						# 恢复被调用者保存寄存器
  4010f3:	c3                   	retq   
...
00000000004010f4 <phase_6>:
  ...
  40110b:	49 89 e6             	mov    %rsp,%r14       # r14 = &input_numbers
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d       # r12d = 0
  401114:	4c 89 ed             	mov    %r13,%rbp       # rbp = &input_numbers
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax  
  40111b:	83 e8 01             	sub    $0x1,%eax      # eax = input_numbers[0] - 1
  40111e:	83 f8 05             	cmp    $0x5,%eax
  401121:	76 05                	jbe    401128 <phase_6+0x34>  # 若eax <= 5跳转到0x401128继续
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>  # 若r12d == 6跳转到0x401153结束，数组中每个元素与输入的第一个元素进行比较，如果不相等则引爆炸弹
  401132:	44 89 e3             	mov    %r12d,%ebx     # ebx = r12d
  401135:	48 63 c3             	movslq %ebx,%rax      # rax = (long) ebx
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax  # eax = input_numbers[r12d]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)   # 比较 eax 和 input_numbers[0]
  40113e:	75 05                	jne    401145 <phase_6+0x51>    # 不相等则继续
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>    # 否则引爆炸弹
  401145:	83 c3 01             	add    $0x1,%ebx
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi    # 从0x401130跳转到这里 
  401158:	4c 89 f0             	mov    %r14,%rax          # rax = &input_numbers
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx          # ecx = 7
  401160:	89 ca                	mov    %ecx,%edx          # edx = 7，从 0x40116d 跳转到这里
  401162:	2b 10                	sub    (%rax),%edx        # edx = 7 - input_numbers[0]
  401164:	89 10                	mov    %edx,(%rax)        # input_numbers[0] = 7 - input_numbers[0]
  401166:	48 83 c0 04          	add    $0x4,%rax          # rax = &input_numbers + 4
  40116a:	48 39 f0             	cmp    %rsi,%rax          # 比较 rax 和 rsi，检查是否处理完所有输入数字（所有数字都被转换为 7 - input_numbers[i]）
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>  # 未处理完则继续
  40116f:	be 00 00 00 00       	mov    $0x0,%esi              # esi = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>  # 跳转到处理下一部分
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx         # 从0x4011a9跳转到这里，rdx = input_numbers[i]
  40117a:	83 c0 01             	add    $0x1,%eax          
  40117d:	39 c8                	cmp    %ecx,%eax              # 比较 eax 和 ecx，检查当前数字是否等于前一个数字加1
  40117f:	75 f5                	jne    401176 <phase_6+0x82>
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx         # 从0x40119d跳转到这里，edx = 0x6032d0
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2) # 把结构体地址存入栈上数组（原来放的是phase_6的输入串）
  40118d:	48 83 c6 04          	add    $0x4,%rsi              # rsi = rsi + 4，移动到下一个 node
  401191:	48 83 fe 18          	cmp    $0x18,%rsi
  401195:	74 14                	je     4011ab <phase_6+0xb7>  # 如果处理完所有输入数字则跳转到0x4011ab继续，否则继续处理下一个数字
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx     # 从0x401174跳转到这里，ecx = input_numbers[i]
  40119a:	83 f9 01             	cmp    $0x1,%ecx              
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>  # 如果ecx数字小于等于1则跳转到0x401183继续处理下一个数字
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>  # 跳转到0x401176处理当前数字
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx        # rbx = nodes[7 - input_numbers[0]]
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax        # rax = &nodes[7 - input_numbers[1]]
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi        
  4011ba:	48 89 d9             	mov    %rbx,%rcx              
  4011bd:	48 8b 10             	mov    (%rax),%rdx          # 循环
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)        # node->next = ($rax)
  4011c4:	48 83 c0 08          	add    $0x8,%rax
  4011c8:	48 39 f0             	cmp    %rsi,%rax              # 比较 rax 和 rsi，检查是否处理完所有节点
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>  # 循环边界
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax         # rax = node->next
  4011e3:	8b 00                	mov    (%rax),%eax            # eax = node->next->value
  4011e5:	39 03                	cmp    %eax,(%rbx)            # 比较 node->next->value 和 node->value
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>  # 要求递减
...
0000000000401204 <fun7>:
  ...
  401208:	48 85 ff             	test   %rdi,%rdi              # 检查输入指针是否为NULL
  40120b:	74 2b                	je     401238 <fun7+0x34>     # 如果输入指针为NULL则跳转到0x401238返回-1
  40120d:	8b 17                	mov    (%rdi),%edx            # edx = 0x24
  40120f:	39 f2                	cmp    %esi,%edx              # 比较输入的数字与父节点
  401211:	7e 0d                	jle    401220 <fun7+0x1c>     # 如果输入的数字大于等于父节点则跳转到0x401220右子树，否则比较左子树
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi         # rdi = node->left
  401217:	e8 e8 ff ff ff       	callq  401204 <fun7>
  40121c:	01 c0                	add    %eax,%eax
  40121e:	eb 1d                	jmp    40123d <fun7+0x39>
  401220:	b8 00 00 00 00       	mov    $0x0,%eax
  401225:	39 f2                	cmp    %esi,%edx
  401227:	74 14                	je     40123d <fun7+0x39>     # 如果输入的数字等于父节点则直接返回0，否则继续比较下一个数字
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi        # rdi = node->right
...
0000000000401242 <secret_phase>:
  ...
  401265:	76 05                	jbe    40126c <secret_phase+0x2a> # 输入的数字必须小于等于1001，否则引爆炸弹
  401267:	e8 ce 01 00 00       	callq  40143a <explode_bomb>
  40126c:	89 de                	mov    %ebx,%esi            # esi = 输入的数字
  40126e:	bf f0 30 60 00       	mov    $0x6030f0,%edi       # 0x6030f0 : 0x24
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>
  401278:	83 f8 02             	cmp    $0x2,%eax    # fun7的返回值必须为2，否则引爆炸弹
